package edu.school21.socialfood.listener;
...
public class RabbitmqListener {
	...
	public void onStudentInfoReceive(Message message) {
		try {
			...
			String filename = String.format("%s-%s_%d-course_%s_social-food.pdf",
			...
			try (FileOutputStream fos = new FileOutputStream(path.toFile())) {
				freemarkerTemplateRender.renderPdf("food-doc.ftl", Collections.singletonMap("student", studentInfo), fos);
				fos.flush();
			}
