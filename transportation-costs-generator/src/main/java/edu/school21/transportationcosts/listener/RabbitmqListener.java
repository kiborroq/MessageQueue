package edu.school21.transportationcosts.listener;
...
public class RabbitmqListener {
	...
	public void onStudentInfoReceive(Message message) {
		try {
			...
			String filename = String.format("%s-%s_%d-course_%s_transportation-costs.pdf",
			...
			try (FileOutputStream fos = new FileOutputStream(path.toFile())) {
				freemarkerTemplateRender.renderPdf("transportation-doc.ftl", Collections.singletonMap("student", studentInfo), fos);
				fos.flush();
			}
