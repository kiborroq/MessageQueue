package edu.school21.guaranteeletter.listener;
...
public class RabbitmqListener {
	...
	public void onStudentInfoReceive(Message message) {
		try {
			...
			String filename = String.format("%s-%s_%d-course_%s_guarantee-letter.pdf",
			...
			try (FileOutputStream fos = new FileOutputStream(path.toFile())) {
				freemarkerTemplateRender.renderPdf("guarantee-doc.ftl", Collections.singletonMap("student", studentInfo), fos);
				fos.flush();
			}
