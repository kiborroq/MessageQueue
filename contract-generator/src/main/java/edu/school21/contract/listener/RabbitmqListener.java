package edu.school21.contract.listener;
...
public class RabbitmqListener {
	...
	public void onStudentInfoReceive(Message message) {
		try {
			...
			String filename = String.format("%s-%s_%d-course_%s_contract.pdf",
			...
			try (FileOutputStream fos = new FileOutputStream(path.toFile())) {
				freemarkerTemplateRender.renderPdf("contract-doc.ftl", Collections.singletonMap("student", studentInfo), fos);
				fos.flush();
			}
